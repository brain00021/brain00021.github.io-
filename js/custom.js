...
=======
          msg = '<a class="profile-nav" href="'+ data.events[i].url + '" target="_blank"><div class="profile-work" style="background:url('+ data.events[i].img + ') no-repeat center center;background-size:cover;"></div>'+msgTitle+'</div></a>'
          $('.profile-collect').append('<div class="swiper-slide profile-article">' + msg + '</div>');
          $('.banner-collect').append('<div class="swiper-slide banner-nav"><img src=' + data.events[i].img + '></div>');
        }
        for(var i =0; i< data.uxdesign.length ; i++){
          ...
          msg = '<a class="profile-nav" href="'+ data.uxdesign[i].url + '" target="_blank"><div class="profile-work" style="background:url('+ data.uxdesign[i].img + ') no-repeat center center"></div>'+msgTitle+'</div></a>'
          $('.profile-collect').append('<div class="swiper-slide profile-article">' + msg + '</div>');
          $('.banner-collect').append('<div class="swiper-slide banner-nav"><img src=' + data.uxdesign[i].img + '></div>');
        }
      }
    ).fail(function(){
      msg = '<h1 style="color:#fff; text-algin:center">資料錯誤</h1>'
